...
import com.selfietime.selfietime.StoryActivity;
    ...
    private void userInfo(final ViewHolder viewHolder, String userid, final int pos) {
        ...
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Glide.with(mContext).load(user.getProfile_image()).into(viewHolder.story_photo);
                if (pos != 0) {
                    Glide.with(mContext).load(user.getProfile_image()).into(viewHolder.story_photo_seen);
                    viewHolder.story_username.setText(user.getUser_name());
                }
            }
                        ...
                        alertDialog.setButton(AlertDialog.BUTTON_POSITIVE, "Add Story",
                                new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog, int which) {
                                        ...
                                        intent.putExtra("image_url", "empty");
                                        mContext.startActivity(intent);
                                        dialog.dismiss();
                                    }
                                });
